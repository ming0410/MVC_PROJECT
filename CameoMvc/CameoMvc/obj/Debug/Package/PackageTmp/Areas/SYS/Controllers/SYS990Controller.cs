...
{
    public class SYS990Controller : Controller
    {
        // GET: SYS/SYS990
        public ActionResult Index()
        {
            string MSG = string.Empty;
            M_SYS990 iData = new M_SYS990();
            M_SYS990 oData = null;
            //FM_SYS990 EXE = new FM_SYS990();
            string ACTION = "Index";
            ...
            try
            {
                if (Request.ServerVariables["HTTP_USER_AGENT"] != null)
                    iData.USER_ANGET = Request.ServerVariables["HTTP_USER_AGENT"];


                iData.BROWSER = FM_SYS.DetectBrowser(Request);
            }
            catch (Exception ex)
            {
                MSG = "例外錯誤"
