...
{
    public class MFG001Controller : Controller
    {
        // GET: MFG/MFG001
        [HttpGet]
        public ActionResult Index()
        {
            ...
            M_MFG001 oData = null;
            M_MFG001 iData = new M_MFG001();
            FM_MFG001 EXE = new FM_MFG001();
            string ACTION = "Index";
        ...
        public ActionResult Index(M_MFG001 iData, string button)
        {
            string MSG = string.Empty;
            M_MFG001 oData = null;
            FM_MFG001 EXE = new FM_MFG001();
            ...
            try
            {
                ...
                if(button != null)
                {
                    ...
                    {
                        QM_MFG001 iQM = new QM_MFG001();
                        string[] Valeus = button.Split('|');
                        iQM.TYPE_NAME = Valeus[1];
                        iQM.ITEM_NAME = Valeus[2];
                    }
                }
