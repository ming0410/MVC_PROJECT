...
{
    public class MFG003Controller : Controller
    {
        // GET: MFG/MFG003
        [HttpGet]
        public ActionResult Index()
        {
            ...
            M_MFG003 oData = null;
            M_MFG003 iData = new M_MFG003();
            FM_MFG003 EXE = new FM_MFG003();
            string ACTION = "Index";
        ...
        public ActionResult Index(M_MFG003 iData, string button)
        {
            string MSG = string.Empty;
            M_MFG003 oData = null;
            FM_MFG003 EXE = new FM_MFG003();
