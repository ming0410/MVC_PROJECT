...
namespace CameoMvc.Models
{
    ...
    public class M_DB
    {
        ...
        public static DataSource dsMes = new DataSource("DATA SOURCE=172.20.1.22:1521/mesdbtest;PERSIST SECURITY INFO=True;USER ID=sajet;password=tech");
        public static DataSource dsWms = new DataSource("DATA SOURCE=172.20.1.20:1521/deltawms;PERSIST SECURITY INFO=True;USER ID=delta;password=deltaDBA!");
    }
    ...
    {
        [NonSerialized]
        private string _ConnectionString = "DATA SOURCE=172.20.1.20:1521/cameomes;PERSIST SECURITY INFO=True;USER ID=sajet;password=tech";
