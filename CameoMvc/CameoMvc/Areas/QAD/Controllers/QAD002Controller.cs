...
{
    public class QAD002Controller : Controller
    {
        [HttpGet]
        public ActionResult Index()
        {
            string MSG = string.Empty;
            M_QAD002 iData = new M_QAD002();
            M_QAD002 oData = null;
            FM_QAD002 EXE = new FM_QAD002();
            string ACTION = "Index";
            ...
            iData.QM.SDate = DateTime.Now.AddMonths(-1).ToString("yyyy/MM/dd");
            iData.QM.EDate = DateTime.Now.ToString("yyyy/MM/dd");
            try
            {
        ...
        public ActionResult Index(M_QAD002 iData, string button)
        {
            string MSG = string.Empty;
            M_QAD002 oData = null;
            FM_QAD002 EXE = new FM_QAD002();
