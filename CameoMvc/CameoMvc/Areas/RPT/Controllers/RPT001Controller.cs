...
{
    public class RPT001Controller : Controller
    {
        [HttpGet]
        public ActionResult Index()
        {
            string MSG = string.Empty;
            M_RPT001 iData = new M_RPT001();
            string ACTION = "Index";
        ...
        public ActionResult Index(M_RPT001 iData)
        {
            string MSG = string.Empty;
            M_RPT001 oData = null;
            FM_RPT001 EXE = new FM_RPT001();
            string ACTION = "Index";
            string FUNC = iData.FUNC;
            string FUNC_NAME = iData.FUNC_NAME;
            ...
            try
            {
                ...
                if (!oData.FLAG)
                {
                    MSG = oData.ERR == null ? string.Empty : oData.ERR;
                }
            }
            catch (Exception ex)
            {
